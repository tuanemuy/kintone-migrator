...
import { type AppInfo, resolveAppName } from "../entity";

describe("resolveAppName", () => {
  it("codeが空でない場合、codeを返す", () => {
    const app: AppInfo = { appId: "1", code: "myapp", name: "My App" };
    expect(resolveAppName(app)).toBe("myapp");
  });

  it("codeが空文字の場合、アプリ名を返す", () => {
    const app: AppInfo = { appId: "42", code: "", name: "My App" };
    expect(resolveAppName(app)).toBe("My App");
  });

  it("codeとnameが両方空の場合、app-{appId}を返す", () => {
    const app: AppInfo = { appId: "42", code: "", name: "" };
  ...
  it("スラッシュを含むcodeをサニタイズする", () => {
    const app: AppInfo = { appId: "1", code: "my/app/name", name: "My App" };
  ...
  it("ドットのみのcodeの場合、_を返す", () => {
    const app: AppInfo = { appId: "1", code: "...", name: "My App" };
